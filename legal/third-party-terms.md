...
Some third-party services accessible through dez have their own acceptable use policies. These apply when you connect your own account or API key to use them within dez. The applicable policies are listed below and apply alongside the [dez Terms of Service](/terms) and [dez Privacy Policy](/privacy-policy).
