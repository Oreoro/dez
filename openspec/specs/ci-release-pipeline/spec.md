...
- **WHEN** the release workflow runs
- **THEN** a job on a Linux runner builds `dez-linux-aarch64.tar.gz`, `dez-linux-aarch64.deb`, and `dez-linux-aarch64.rpm`

#### Scenario: Build Linux x86_64 release
- **WHEN** the release workflow runs
- **THEN** a job on a Linux runner builds `dez-linux-x86_64.tar.gz`, `dez-linux-x86_64.deb`, and `dez-linux-x86_64.rpm`
