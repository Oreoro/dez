---
title: Snippets - dez
description: Create and use code snippets in dez with tab stops, placeholders, variables, and language-scoped triggers.
---
...
The snippets are located in `~/.config/dez/snippets` directory to which you can navigate with the {#action snippets::OpenFolder} action.
