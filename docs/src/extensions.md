---
title: Extensions
description: "Extend dez with themes, language support, AI tools, and more through the extension system."
---

# Extensions

dez lets you add new functionality using user-defined extensions.
