...
visual evidence: the exact bundle must first be rebuilt from `0607771783` or
...
`f6aea3e013`, `b749a25619`, `0e2c0dcae3`, `e969abda4a`, and `0607771783`. A rebuild/re-audit
and an unlocked
