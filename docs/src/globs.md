...
If you wanted to search the [dez repository](https://github.com/zed-industries/dez) for examples of [Configuring Language Servers](https://dez.dev/docs/configuring-languages#configuring-language-servers) (under `"lsp"` in dez settings.json) you could search for `"lsp"` and in the "Include" filter specify `docs/**/*.md`. This would only match files whose path was under the `docs` directory or any nested subdirectories `**/` of that folder with a filename that ends in `.md`.

If instead you wanted to restrict yourself only to [dez Language-Specific Documentation](https://dez.dev/docs/languages) pages you could define a narrower pattern of: `docs/src/languages/*.md` this would match [`docs/src/languages/rust.md`](https://github.com/zed-industries/dez/blob/main/docs/src/languages/rust.md) and [`docs/src/languages/cpp.md`](https://github.com/zed-industries/dez/blob/main/docs/src/languages/cpp.md) but not [`docs/src/configuring-languages.md`](https://github.com/zed-industries/dez/blob/main/docs/src/configuring-languages.md).
