# Terminal-First dez Fork

## Purpose

This fork turns dez into a terminal-first code review and writing workspace.
...
- Native dez agent/chat: agent panel chat, inline assistant, agent tools, tool
...
- Native model providers: Anthropic, OpenAI, Google, Bedrock, Ollama,
  OpenRouter, DeepSeek, Mistral, LM Studio, xAI, OpenCode provider UI, dez cloud
...
- dez cloud/product surfaces: account settings, hosted model onboarding,
  feedback, social/help links specific to dez, telemetry UI.
...
Keep AI-assisted commit message generation, but do not keep dez's full native
...
- App startup feature registration: `crates/dez/src/main.rs`
- Workspace panel loading: `crates/dez/src/dez.rs`
- App menus: `crates/dez/src/dez/app_menus.rs`
...
- Confirm removed surfaces are absent from default menus and command palette:
  ...
  collaboration/calls, debugger/DAP panels, and dez cloud product entries.
