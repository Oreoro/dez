...
pub(crate) fn line_ending_picker_density(cx: &App) -> PickerSurfaceDensity {
...
pub(crate) fn line_ending_picker_radius(cx: &App) -> PickerSurfaceRadius {
...
pub(crate) fn line_ending_picker_contrast(cx: &App) -> PickerSurfaceContrast {
...
pub(crate) fn line_ending_row_spacing(cx: &App) -> ListItemSpacing {
    match DesignSystemSettings::get_global(cx).density {
