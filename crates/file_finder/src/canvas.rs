...
pub(crate) fn file_finder_picker_density(cx: &App) -> PickerSurfaceDensity {
...
pub(crate) fn file_finder_picker_radius(cx: &App) -> PickerSurfaceRadius {
...
pub(crate) fn file_finder_picker_contrast(cx: &App) -> PickerSurfaceContrast {
...
pub(crate) fn file_finder_row_spacing(cx: &App) -> ListItemSpacing {
    match DesignSystemSettings::get_global(cx).density {
...
pub(crate) fn file_finder_gap(cx: &App) -> Pixels {
    match DesignSystemSettings::get_global(cx).density {
