...
impl Pane {
    ...
    pub fn close_items(
        ...
        items_to_close.sort_by_key(|item| {
            ...
            // This will cause dez to expand the content of the currently active item
            //
                                ...
                                .when(is_local, |menu| {
                                    menu.when_some(reveal_path, |menu, reveal_path| {
                                        menu.separator().entry(
                                            ...
                                            Some(Box::new(
                                                dez_actions::editor::RevealInFileManager,
                                            )),
    ...
    fn render_tab_bar(&mut self, window: &mut Window, cx: &mut Context<Pane>) -> AnyElement {
        ...
        if self.is_tab_pinned(tab_count) {
            log::warn!(
                ...
                in a comment, to https://github.com/zed-industries/dez/issues/33342",
                self.pinned_tab_count,
                tab_count
            );
