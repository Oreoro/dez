...
pub(crate) fn tab_switcher_picker_density(cx: &App) -> PickerSurfaceDensity {
...
pub(crate) fn tab_switcher_picker_radius(cx: &App) -> PickerSurfaceRadius {
...
pub(crate) fn tab_switcher_picker_contrast(cx: &App) -> PickerSurfaceContrast {
...
pub(crate) fn tab_switcher_row_spacing(cx: &App) -> ListItemSpacing {
    match DesignSystemSettings::get_global(cx).density {
...
pub(crate) fn tab_switcher_indicator_gap(cx: &App) -> Pixels {
    match DesignSystemSettings::get_global(cx).density {
