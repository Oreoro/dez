...
// If the dez binary doesn't use anything in this crate, it will be optimized away
...
#[action(namespace = dez, no_json, no_register)]
...
actions!(
    ...
    [
        ...
        #[action(deprecated_aliases = ["dez_actions::OpenSettingsEditor"])]
        OpenSettings,
        /// Opens the settings JSON file.
        #[action(deprecated_aliases = ["dez_actions::OpenSettings"])]
        OpenSettingsFile,
        /// Opens project-specific settings.
        #[action(deprecated_aliases = ["dez_actions::OpenProjectSettings"])]
        OpenProjectSettings,
        /// Opens the default keymap file.
        OpenDefaultKeymap,
        /// Opens the user keymap file.
        #[action(deprecated_aliases = ["dez_actions::OpenKeymap"])]
        OpenKeymapFile,
        /// Opens the keymap editor.
        #[action(deprecated_aliases = ["dez_actions::OpenKeymapEditor"])]
        OpenKeymap,
        /// Opens server settings.
        OpenServerSettings,
        /// Quits the application.
        Quit,
        /// Shows information about dez.
        About,
        /// Opens the documentation website.
        OpenDocs,
        /// Views open source licenses.
        OpenLicenses,
        /// Opens the dez status page.
        OpenStatusPage,
        /// Opens the performance profiler.
        OpenPerformanceProfiler,
        /// Opens the onboarding view.
        OpenOnboarding,
        /// Opens the dez Agent Thread control skill manager.
...
pub struct CreateWorktree {
    /// When this is None, dez will randomly generate a worktree name.
...
pub mod feedback {
    ...
    actions!(
        feedback,
        [
            /// Opens a new GitHub issue to send feedback about dez.
            Emaildez,
