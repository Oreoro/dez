...
impl Fs for RealFs {
    ...
    async fn trash(&self, path: &Path, _options: RemoveOptions) -> Result<TrashedEntry> {
        ...
        // of the dez working directory (not usually the worktree) and whatever
    ...
    async fn atomic_write(&self, path: PathBuf, data: String) -> Result<()> {
        smol::unblock(move || {
            ...
            // See https://github.com/zed-industries/dez/pull/8437 for more details.
            let mut tmp_file =
    ...
    async fn atomic_write(&self, path: PathBuf, data: String) -> Result<()> {
        smol::unblock(move || {
            ...
            // https://github.com/zed-industries/dez/issues/16571
