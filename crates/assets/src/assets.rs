// This crate was essentially pulled out verbatim from main `dez` crate to avoid having to run RustEmbed macro whenever dez has to be rebuilt. It saves a second or two on an incremental build.
