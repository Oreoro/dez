...
impl Motion {
    fn default_kind(&self) -> MotionKind {
        ...
        match self {
            ...
            | SneakBackward { .. }
            | Jump { .. }
            | dezSearchResult { .. } => MotionKind::Exclusive,
    ...
    pub fn move_point(
        ...
        let (new_point, goal) = match self {
            ...
            dezSearchResult { new_selections, .. } => {
...
fn up_down_buffer_rows(
    ...
    //
    // See: https://github.com/zed-industries/dez/issues/29134
