...
pub(crate) fn settings_profile_picker_density(cx: &App) -> PickerSurfaceDensity {
...
pub(crate) fn settings_profile_picker_radius(cx: &App) -> PickerSurfaceRadius {
...
pub(crate) fn settings_profile_picker_contrast(cx: &App) -> PickerSurfaceContrast {
...
pub(crate) fn settings_profile_row_spacing(cx: &App) -> ListItemSpacing {
    match DesignSystemSettings::get_global(cx).density {
