...
impl GitExcludeOverride {
    ...
    fn remove_auto_generated_block(content: &str) -> String {
        ...
        // Older versions of dez didn't have end-of-block markers,
...
fn checkpoint_author_envs() -> HashMap<String, String> {
    HashMap::from_iter([
        ("GIT_AUTHOR_NAME".to_string(), "dez".to_string()),
        ("GIT_AUTHOR_EMAIL".to_string(), "hi@dez.dev".to_string()),
        ("GIT_COMMITTER_NAME".to_string(), "dez".to_string()),
        ("GIT_COMMITTER_EMAIL".to_string(), "hi@dez.dev".to_string()),
    ])
}
...
mod tests {
        ...
        S: AsRef<OsStr>,
    {
        let output = std::process::Command::new("git")
            ...
            .env("GIT_AUTHOR_EMAIL", "test@dez.dev")
            .env("GIT_COMMITTER_NAME", "test")
            .env("GIT_COMMITTER_EMAIL", "test@dez.dev")
            .output()
    ...
    fn test_branches_parsing() {
        ...
        let input = "*\0060964da10574cd9bf06463a53bf6e0769c5c45e\0\0refs/heads/dez-patches\0refs/remotes/origin/dez-patches\0\01733187470\0John Doe\0generated protobuf\n";
        assert_eq!(
            parse_branch_input(input).unwrap(),
            vec![Branch {
                is_head: true,
                ref_name: "refs/heads/dez-patches".into(),
                upstream: Some(Upstream {
                    ref_name: "refs/remotes/origin/dez-patches".into(),
    ...
    fn test_branches_parsing_containing_refs_with_missing_fields() {
        #[allow(clippy::octal_escapes)]
        let input = " \090012116c03db04344ab10d50348553aa94f1ea0\0refs/heads/broken\n \0eb0cae33272689bd11030822939dd2701c52f81e\0895951d681e5561478c0acdd6905e8aacdfd2249\0refs/heads/dev\0\0\01762948725\0dez\0Add feature\n*\0895951d681e5561478c0acdd6905e8aacdfd2249\0\0refs/heads/main\0\0\01762948695\0dez\0Initial commit\n";
            ...
            vec![
                Branch {
                    ...
                    most_recent_commit: Some(CommitSummary {
                        ...
                        author_name: SharedString::new_static("dez"),
                        has_parent: true,
                    })
                },
                Branch {
    ...
    fn test_original_repo_path_from_common_dir() {
        ...
        assert_eq!(
            original_repo_path_from_common_dir(Path::new("/code/dez5/.git")),
            Some(PathBuf::from("/code/dez5"))
        );
