...
use ui::{
    Banner, ContextMenu, Divider, DropdownMenu, DropdownStyle, Severity, Tooltip, prelude::*,
};
...
const SETTINGS_DISCLAIMER: &str = "Custom tool permissions apply only to the Dez native agent; external ACP agents enforce their own permissions.";
