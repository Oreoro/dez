...
AppPublisher=dez Industries
AppPublisherURL=https://www.dez.dev/
AppSupportURL=https://www.dez.dev/
AppUpdatesURL=https://www.dez.dev/
...
[Files]
Source: "{#ResourcesDir}\dez.exe"; DestDir: "{code:GetInstallDir}"; Flags: ignoreversion
Source: "{#ResourcesDir}\dezctl.exe"; DestDir: "{code:GetInstallDir}"; Flags: ignoreversion
...
; URI Scheme
Root: HKCU; Subkey: "Software\Classes\dez"; ValueType: "string"; ValueData: "URL:dez Protocol"; Flags: uninsdeletekey
Root: HKCU; Subkey: "Software\Classes\dez"; ValueType: "string"; ValueName: "URL Protocol"; ValueData: ""
Root: HKCU; Subkey: "Software\Classes\dez\DefaultIcon"; ValueType: "string"; ValueData: "{app}\dez.exe,1"
Root: HKCU; Subkey: "Software\Classes\dez\shell\open\command"; ValueType: "string"; ValueData: """{app}\dez.exe"" ""%1"""
...
begin
  if WizardIsTaskSelected('addcontextmenufiles') then begin
    ShellExec('', 'powershell.exe', '-Command ' + AddQuotes('Add-AppxPackage -Path ''' + ExpandConstant('{app}\appx\dez_explorer_command_injector.appx') + ''' -ExternalLocation ''' + ExpandConstant('{app}\appx') + ''''), '', SW_HIDE, ewWaitUntilTerminated, AddAppxPackageResultCode);
