...
//! Visual testing infrastructure for dez.
//!
//! This module provides utilities for visual regression testing of dez's UI.
//! It allows capturing screenshots of the real dez application window and comparing
...
//! cargo test -p dez visual_tests -- --ignored --test-threads=1
//!
//! # Update baselines when UI intentionally changes
//! UPDATE_BASELINES=1 cargo test -p dez visual_tests -- --ignored --test-threads=1
//! ```
//!
//! ## Screenshot Output
//!
...
/// Initialize a visual test context with all necessary dez subsystems.
...
mod tests {
    ...
    /// This test captures a screenshot of an empty dez workspace.
    ///
