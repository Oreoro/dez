...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "dez Editor Dev Instance Running",
        ReleaseChannel::Nightly => "dez Editor Nightly Instance Running",
        ReleaseChannel::Preview => "dez Editor Preview Instance Running",
        ReleaseChannel::Stable => "dez Editor Stable Instance Running",
    }
}
