                        ...
                        .when(!is_deployed, |this| {
                            this.when(has_available_code_actions, |this| {
                                this.tooltip(Tooltip::for_action_title(
                                    localization::text(cx, "dez-code-actions"),
                            ...
                            .when(
                                ...
                                |this| {
                                    this.tooltip(Tooltip::for_action_title(
                                        localization::text(cx, "dez-no-code-actions"),
                                        &ToggleCodeActions::default(),
                                    ))
                                },
                            )
        ...
        let editor_selections_dropdown = selection_menu_enabled.then(|| {
            ...
            PopoverMenu::new("editor-selections-dropdown")
                .trigger_with_tooltip(
                    ...
                    Tooltip::text(localization::text(cx, "dez-selection-controls")),
                )
                    ...
                    let menu = ContextMenu::build(window, cx, move |menu, _, cx| {
                        menu.context(focus.clone())
                            ...
                            .action_disabled_when(
                                !has_diff_hunks,
                                localization::text(cx, "dez-next-hunk"),
                                Box::new(GoToHunk),
                            )
                            .action_disabled_when(
                                !has_diff_hunks,
                                localization::text(cx, "dez-previous-hunk"),
        ...
        let editor_settings_dropdown = {
            ...
            PopoverMenu::new("editor-settings")
                .trigger_with_tooltip(
                    ...
                    Tooltip::text(localization::text(cx, "dez-editor-controls")),
                )
                .anchor(Anchor::TopRight)
                        ...
                        |mut menu, _, cx| {
                            ...
                            if supports_inlay_hints {
                                menu = menu.toggleable_entry(
                                    localization::text(cx, "dez-inlay-hints"),
                                    inlay_hints_enabled,
                                    IconPosition::Start,
                            ...
                            if supports_semantic_tokens {
                                menu = menu.toggleable_entry(
                                    localization::text(cx, "dez-semantic-highlights"),
                            ...
                            if supports_code_lens {
                                menu = menu.toggleable_entry(
                                    localization::text(cx, "dez-code-lens"),
                                    code_lens_enabled,
                                    IconPosition::Start,
                            ...
                            if supports_minimap {
                                menu = menu.toggleable_entry(
                                    localization::text(cx, "dez-minimap"),
                                    minimap_enabled,
                                    IconPosition::Start,
                            ...
                            if is_full {
                                menu = menu.toggleable_entry(
                                    localization::text(cx, "dez-diagnostics"),
                                    diagnostics_enabled,
                                    IconPosition::Start,
                                ...
                                if supports_inline_diagnostics {
                                    let mut inline_diagnostics_item = ContextMenuEntry::new(
                                        localization::text(cx, "dez-inline-diagnostics"),
                                    )
                                    .toggleable(
                                        IconPosition::Start,
                                        ...
                                        inline_diagnostics_item = inline_diagnostics_item
                                            ...
                                            .documentation_aside(DocumentationSide::Left, |cx| {
                                                Label::new(localization::text(
                                                    cx,
                                                    "dez-inline-diagnostics-unavailable",
                                                ))
                                                .into_any_element()
                                            });
                                    }
                            ...
                            menu = menu.toggleable_entry(
                                localization::text(cx, "dez-line-numbers"),
                                show_line_numbers,
                                IconPosition::Start,
                            ...
                            menu = menu.toggleable_entry(
                                localization::text(cx, "dez-selection-menu"),
                            ...
                            menu = menu.toggleable_entry(
                                localization::text(cx, "dez-auto-signature-help"),
                            ...
                            menu = menu.toggleable_entry(
                                localization::text(cx, "dez-inline-git-blame"),
                            ...
                            menu = menu.toggleable_entry(
                                localization::text(cx, "dez-column-git-blame"),
                            ...
                            menu = menu.toggleable_entry(
                                localization::text(cx, "dez-vim-mode"),
                                vim_mode_enabled,
                                IconPosition::Start,
                                None,
                                {
                            ...
                            menu = menu.toggleable_entry(
                                localization::text(cx, "dez-helix-mode"),
                                helix_mode_enabled,
                                IconPosition::Start,
                                None,
                                {
