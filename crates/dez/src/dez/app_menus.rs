...
pub fn app_menus(cx: &mut App) -> Vec<Menu> {
    use dez_actions::Quit;

    let mut view_items = vec![
        MenuItem::action(
            menu_text(cx, "menu-zoom-in"),
            dez_actions::IncreaseBufferFontSize { persist: false },
        ),
        MenuItem::action(
            menu_text(cx, "menu-zoom-out"),
            dez_actions::DecreaseBufferFontSize { persist: false },
        ),
        MenuItem::action(
            menu_text(cx, "menu-reset-zoom"),
            dez_actions::ResetBufferFontSize { persist: false },
        ),
        MenuItem::action(
            menu_text(cx, "menu-reset-all-zoom"),
            dez_actions::ResetAllZoom { persist: false },
        ),
        MenuItem::separator(),
        MenuItem::action(
        ...
        MenuItem::action(
            ...
            dez_actions::project_panel::ToggleFocus,
        ),
        MenuItem::action(
        ...
        MenuItem::action(
            ...
            dez_actions::Extensions::default(),
        ),
        MenuItem::action(
    ...
    vec![
        Menu {
            name: menu_text(cx, "menu-dez"),
            disabled: false,
            items: vec![
                MenuItem::action(menu_text(cx, "menu-about-dez"), dez_actions::About),
                ...
                MenuItem::submenu(Menu::new(menu_text(cx, "menu-settings")).items([
                    ...
                    MenuItem::separator(),
                    MenuItem::action(menu_text(cx, "menu-open-keymap"), dez_actions::OpenKeymap),
                    MenuItem::action(
                        menu_text(cx, "menu-open-keymap-file"),
                        dez_actions::OpenKeymapFile,
                    ),
                    MenuItem::action(
                    ...
                    MenuItem::action(
                        ...
                        dez_actions::theme_selector::Toggle::default(),
                    ),
                    MenuItem::action(
                        menu_text(cx, "menu-select-icon-theme"),
                        dez_actions::icon_theme_selector::Toggle::default(),
                    ),
                ])),
                MenuItem::separator(),
                #[cfg(target_os = "macos")]
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::action(
                    ...
                    dez_actions::text_finder::Toggle,
                ),
                MenuItem::separator(),
                MenuItem::action(
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::action(
                    ...
                    dez_actions::command_palette::Toggle,
                ),
                MenuItem::separator(),
                MenuItem::action(
                ...
                MenuItem::action(
                    ...
                    dez_actions::outline::ToggleOutline,
                ),
                MenuItem::action(
