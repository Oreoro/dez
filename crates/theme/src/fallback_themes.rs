...
/// The default theme family for dez.
///
...
pub fn dez_default_themes() -> ThemeFamily {
    ThemeFamily {
        id: "dez-default".to_string(),
        name: "dez Default".into(),
        author: "".into(),
        themes: vec![dez_default_dark()],
...
pub(crate) fn dez_default_dark() -> Theme {
