...
pub(crate) fn open_path_picker_density(cx: &App) -> PickerSurfaceDensity {
...
pub(crate) fn open_path_picker_radius(cx: &App) -> PickerSurfaceRadius {
...
pub(crate) fn open_path_picker_contrast(cx: &App) -> PickerSurfaceContrast {
...
pub(crate) fn open_path_row_spacing(cx: &App) -> ListItemSpacing {
    match DesignSystemSettings::get_global(cx).density {
