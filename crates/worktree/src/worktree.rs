...
///
/// Has an absolute path, and may be set to be visible in dez UI or not.
...
/// * a directory opened in dez — may be added as a visible entry to the current worktree
///
...
impl BackgroundScanner {
    ...
    async fn process_events(&self, mut events: Vec<PathEvent>) {
        ...
        //
        // Certain directories may have FS changes, but do not lead to git data changes that dez cares about.
        // Ignore these, to avoid dez unnecessarily rescanning git metadata.
