...
const NOUNS: &[&str] = &[
    ...
    "coyote", "crane", "crater", "creek", "crest", "curlew", "daisy", "dale", "dawn", "den", "dez",
    "dove", "drake", "drift", "drum", "dune", "dusk", "eagle", "eel", "egret", "elk", "emu",
    "falcon", "fawn", "fennel", "fern", "ferret", "ferry", "fig", "finch", "fjord", "flicker",
    "flower", "fox", "frost", "gale", "garnet", "gate", "gazelle", "geyser", "glade", "glen",
    "gorge", "granite", "grove", "gull", "harbor", "hare", "haven", "hawk", "hazel", "heath",
    "hedge", "heron", "hill", "hollow", "horizon", "ibis", "inlet", "isle", "ivy", "jackal",
    "jasper", "juniper", "kinglet", "kitten", "knoll", "lagoon", "lake", "lantern", "larch",
    "lark", "laurel", "lava", "leaf", "ledge", "lily", "linden", "lodge", "loft", "loon", "lotus",
    "mantle", "maple", "marble", "marsh", "marten", "meadow", "merlin", "mill", "minnow", "moon",
    "moose", "moss", "moth", "newt", "north", "nutmeg", "oak", "oasis", "obsidian", "orbit",
    "orchid", "oriole", "osprey", "otter", "owl", "palm", "panther", "pass", "peach", "peak",
    "pebble", "pelican", "peony", "perch", "pier", "pike", "pine", "plover", "plume", "pond",
    "poppy", "prairie", "prism", "quail", "quarry", "quartz", "rain", "rampart", "raven", "ravine",
    "reed", "reef", "ridge", "river", "robin", "rook", "rowan", "sage", "salmon", "sequoia",
    "shore", "shrew", "shrike", "sigma", "sky", "slope", "snipe", "snow", "sparrow", "spruce",
    "stag", "star", "starling", "stoat", "stone", "stork", "storm", "strand", "summit", "sycamore",
    "tern", "terrace", "thistle", "thorn", "thrush", "tide", "timber", "toucan", "trail", "trout",
    "tulip", "tundra", "turtle", "vale", "valley", "veranda", "violet", "viper", "vole", "walrus",
    "warbler", "willow", "wolf", "wren", "yak", "zenith",
];
