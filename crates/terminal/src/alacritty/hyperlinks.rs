...
mod tests {
    ...
    fn test_url_punctuation_sanitization() {
        ...
        let test_cases = vec![
            ("https://example.com.", "https://example.com"),
            (
                "https://github.com/zed-industries/dez.",
                "https://github.com/zed-industries/dez",
            ),
            (
    ...
    mod path {
        ...
        mod issues {
            ...
            #[test]
            // <https://github.com/zed-industries/dez/issues/12338>
            ...
            #[test]
            // <https://github.com/zed-industries/dez/issues/40202>
            fn issue_40202() {
                // Elixir
            ...
            #[test]
            // <https://github.com/zed-industries/dez/issues/28194>
            fn issue_28194() {
                test_path!(
            ...
            #[test]
            // <https://github.com/zed-industries/dez/issues/50531>
            fn issue_50531() {
            ...
            #[test]
            // <https://github.com/zed-industries/dez/issues/46795>
            fn issue_46795() {
        ...
        mod perf {
            ...
            pub fn cargo_hyperlink_benchmark() {
                const LINE: &str = "    Compiling terminal v0.1.0 (/Hyperlinks/Bench/Source/dez-hyperlinks/crates/terminal)\r\n";
                thread_local! {
                ...
                TEST_TERM_AND_POINT.with(|(term, point)| {
                    assert_eq!(
                        find_from_grid_point_bench(term, *point)
                            ...
                            .unwrap_or_default(),
                        "/Hyperlinks/Bench/Source/dez-hyperlinks/crates/terminal",
            ...
            pub fn rust_hyperlink_benchmark() {
                const LINE: &str = "    --> /Hyperlinks/Bench/Source/dez-hyperlinks/crates/terminal/terminal.rs:1000:42\r\n";
                thread_local! {
                    static TEST_TERM_AND_POINT: (Term<VoidListener>, AlacPoint) =
                        build_test_term(LINE, 500, 50);
                }
                TEST_TERM_AND_POINT.with(|(term, point)| {
                    assert_eq!(
                        find_from_grid_point_bench(term, *point)
                            .map(|hyperlink| hyperlink.text)
                            .unwrap_or_default(),
                        "/Hyperlinks/Bench/Source/dez-hyperlinks/crates/terminal/terminal.rs:1000:42",
                        "Hyperlink should have been found"
                    );
                });
            }
            ...
            #[perf]
            // https://github.com/zed-industries/dez/pull/44407
...
";
            ...
            #[perf]
            // https://github.com/zed-industries/dez/issues/44510
    ...
    mod file_iri {
        ...
        mod windows {
            mod issues {
                ...
                // See https://en.wikipedia.org/wiki/File_URI_scheme
                // https://github.com/zed-industries/dez/issues/39189
                #[test]
                fn issue_39189() {
