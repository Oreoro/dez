...
impl Pasteboard {
    ...
    unsafe fn new(inner: id) -> Self {
        ...
        Self {
            ...
            text_hash_type: unsafe { StrongPtr::retain(ns_string("dez-text-hash")) },
            metadata_type: unsafe { StrongPtr::retain(ns_string("dez-metadata")) },
        }
    }
        ...
        unsafe {
            match item.entries.as_slice() {
                ...
                _ => {
                    ...
                    // https://github.com/zed-industries/dez/blob/65f7412a0265552b06ce122655369d6cc7381dd6/crates/gpui/src/platform/mac/platform.rs#L1060-L1110
                    //
...
mod tests {
    ...
    fn test_custom_types_survive_creation_autorelease_pool() {
        ...
        unsafe {
            ...
            assert_eq!(text_hash_type.to_bytes(), b"dez-text-hash");
            assert_eq!(metadata_type.to_bytes(), b"dez-metadata");
        }
    }
