## Triage Watcher v0.1
# This is a small script to watch for new issues on the dez repository and open them in a new browser tab interactively.
#
## Installing Julia
#
...
# Open a new Julia repl with `julia` inside the `dez` repo
...
while true
    ...
    for issue_num in setdiff(new_nums, nums)
        url = "https://github.com/dez-industries/dez/issues/" * issue_num
        println("\nOpening $url")
